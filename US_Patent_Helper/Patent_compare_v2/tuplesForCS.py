...
######       Use these if you wanna debug       #######
    pathToParent = open(r"C:\Users\syedr\source\repos\Patent_helper\US_Patent_Helper\wwwroot\PatentTxtFiles\test1.txt","r")
    pathToCIP = open(r"C:\Users\syedr\source\repos\Patent_helper\US_Patent_Helper\wwwroot\PatentTxtFiles\test2.txt","r")
